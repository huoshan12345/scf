...
#define SCF_DAG_ASSIGN_DEREFERENCE(name, op) \
static int _scf_dag_op_##name##_dereference(scf_list_t* h, scf_dag_node_t* parent, scf_dag_node_t** nodes, int nb_nodes) \
{ \
